...
class LmChatOpenCodeZen {
    description = {
        ...
        properties: [
            ...
            },
            {
                ...
                description: 'The Zen model ID. List is fetched live from the gateway. Free models are marked "-free".',
            },
            {
                displayName: 'Options',
                name: 'options',
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            },
                            {
                                ...
                                value: 'openai',
                                description: 'POST {baseUrl}/chat/completions. Works for GPT, Grok, DeepSeek, GLM, Kimi, MiniMax, Gemini and most Claude models behind the Zen gateway.',
                            },
                            {
                                name: 'Anthropic Messages',
                                value: 'anthropic',
                                description: 'POST {gateway}/v1/messages with x-api-key headers. For Claude/Qwen models needing native semantics.',
                            },
                        ],
    ...
    async supplyData(itemIndex) {
        const credentials = await this.getCredentials('openCodeZenApi');
...
exports.LmChatOpenCodeZen = LmChatOpenCodeZen;
